    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-white">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl px-8 py-10">
        ...
        <div className="flex flex-row mt-4 justify-between">
          <Link href="/doctor/forgot-password" className="text-xs font-medium text-[#1EAEDB] hover:underline">
            Forgot password?
          </Link>
          <Link href="/doctor/signup" className="text-xs ml-2 font-medium text-[#1EAEDB] hover:underline">
            Sign up
          </Link>
        </div>
      </div>
