...
const PatientDetailPanel: React.FC<PatientDetailPanelProps> = ({ patient, onClose }) => {
  ...
  // collapsible area might be added if this was an inline slide out, for now fixed right panel

  return (
    <div className="fixed inset-0 z-50 bg-black/20 flex justify-end">
      <div className="w-full max-w-3xl h-full bg-white shadow-2xl flex flex-col relative overflow-y-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-6 p-6">
          ...
          <div className="w-full sm:w-1/3 border-r pr-6 mb-6 sm:mb-0">
