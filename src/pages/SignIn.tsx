    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-[#F1F0FB] to-[#9b87f5]">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl px-8 py-10">
        ...
        <form className="flex flex-col gap-4">
          ...
          <Button type="submit" className="w-full bg-[#9b87f5] text-white hover:bg-[#7E69AB]">Sign In</Button>
        </form>
        <div className="flex flex-row mt-4 justify-between">
          <Link to="/forgot-password" className="text-xs font-medium text-primary hover:underline text-[#7E69AB]">Forgot password?</Link>
          <Link to="/signup" className="text-xs ml-2 font-medium text-[#7E69AB] hover:underline">Sign up</Link>
        </div>
      </div>
    </div>
  );
